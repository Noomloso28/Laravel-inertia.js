<script setup>
import {computed, onMounted, ref, watch, reactive, watchEffect,onUnmounted, onBeforeUpdate, onUpdated, onBeforeUnmount,} from 'vue';
...
watchEffect( () => {
  if((show.value === true) && message.value){
    setHideTimer();
  }
});
...
//   console.log([show.value, message.value]);
// });
// onBeforeUnmount(() => {
//   setHideTimer();
// });
...
<template>
    <div class="w-full px-4">
        ...
        <div v-if="show && message" :class="{ 'bg-emerald-500': style == 'success', 'bg-red-700': style == 'danger' }" class="relative z-2 rounded">

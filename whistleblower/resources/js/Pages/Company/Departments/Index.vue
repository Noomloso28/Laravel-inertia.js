...
const searchField = ["name", "id", "default", "created_at", "updated_at"];
const sortBy= "id";
const sortType = "desc";

const headers = [
    { text: "Name", value: "name", sortable: true},
    { text: "Types", value: "default", sortable: true},
                ...
                >
                    <div class="rounded-t bg-white mb-0 px-6 py-6">
                        <div class="text-center flex justify-between">
                            <h6 class="text-blueGray-700 text-xl font-bold mr-2">{{$t('Departments')}}</h6>
                            <div class="relative flex">
                              ...
                              <Link v-if="$page.props.user.permissions.includes('create-departments')"
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        >
                            ...
                            <template #item-default="type">
                              <span v-if="type.default">{{$t('Default')}}</span>
                              <span v-else>{{$t('Custom')}}</span>
                            </template>
                            <template #item-actions="{id}">
                                <table-dropdown :id="id" :group="'departments'" :view="false"/>
                            </template>

...
<!--                                      <option v-for="values in props.user_companies" :value="values.companies.id">{{values.companies.name}}</option>-->
<!--                                    </select>-->
<!--                                    <span class="text-red-600" v-if="form.errors.company_id">-->
<!--                                          {{ $t(form.errors.company_id, { 'Name': form.company_id }) }}-->
<!--                                    </span>-->
<!--                                  </div>-->
<!--                                  <div class="relative w-full mb-6">-->
...
<!--                                            </span>-->
<!--                                  </div>-->
                                    <div class="relative w-full mb-6" v-if="props.is_admin">
                                      <TextLabel for="default" value="Type" class="block uppercase text-blueGray-600 text-xs font-bold mb-2" />
                                      <div class="flex">
                                        <div class="flex items-center mr-4">
                                          <input v-model="form.default" checked id="default-enable" type="radio" value="1" name="default" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                          <label for="default-enable" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{$t('Default')}}</label>
                                        </div>

                                        <div class="flex items-center mr-4">
                                          <input v-model="form.default" id="default-disable" type="radio" value="0" name="default" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                          <label for="default-disable" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{$t('Custom')}}</label>
                                        </div>

                                      </div>
                                      <span class="text-red-600" v-if="form.errors.default">
...
<script setup>
    ...
    const form = useForm({
        ...
        default: props.category.default,

<script setup>
    ...
    const view = useForm({
        ...
        company: props.categories.companies.name,
        active: props.categories.active,
        create: props.categories.created_at,
        update: props.categories.updated_at,
    });
                            ...
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                                    ...
                                    <div class="w-full lg:text-right lg:self-center">
                                        <div class="py-6 px-3 mt-32 sm:mt-0">
                                            <Link
                                                ...
                                                :href="route('categories.edit', view.id)"
                                            >
                                                {{$t('Edit')}}
                                            </Link>
                                            <Link
                                ...
                                <div class="text-center mt-12">
                                    ...
                                    <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                                        <i class="fas fa-fa-university mr-2 text-lg text-blueGray-400"></i> {{view.company}}
                                    </div>
                                  <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                                    <i class="fas fa-map-marker-alt mr-2 text-lg text-blueGray-400"></i> {{view.create}}
                                  </div>
                                    <div class="mb-2 text-blueGray-600 mt-10">
                                        <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i> {{view.update}}
                                    </div>

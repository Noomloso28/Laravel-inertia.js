...
const searchField = ["name", "index", 'default', "created_at", "updated_at"];
const sortBy= "id";
const sortType = "asc";
                ...
                >
                    <div class="rounded-t bg-white mb-0 px-6 py-6">
                        <div class="text-center flex justify-between">
                            <h6 class="text-blueGray-700 text-xl font-bold mr-2">{{$t('Categories')}}</h6>
                            <div class="relative flex">
                              ...
                              <Link v-if="$page.props.user.permissions.includes('create-categories')"
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        >
                            ...
                            <template #item-default="type">
                              <span v-if="type.default">Default</span>
                            ...
                            <template #item-actions="{id}">
                                <table-dropdown :id="id" :group="'categories'" :view="false"/>
                            </template>

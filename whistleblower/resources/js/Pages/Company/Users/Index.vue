...
const searchField = ["name", "id", "active", "created_at", "email", "role_id"];
const sortBy= "name";
const sortType = "desc";
...
const headers = [
    ...
    { text: "Roles", value: "roles.name", sortable: true},
                ...
                >
                    <div class="rounded-t bg-white mb-0 px-6 py-6">
                        <div class="text-center flex justify-between">
                            <h6 class="text-blueGray-700 text-xl font-bold mr-2">{{$t('Users')}}</h6>
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        <Vue3EasyDataTable
                            ...
                            header-class-name="users-header"
                        ...
                        >
                            ...
                            <template #header-roles.name="header">
                              {{$t(header.text)}}
                            </template>
                            ...
                            <template #item-actions="{id}">
                                <table-dropdown :id="id" :group="'users'" :view="false"/>
                            </template>

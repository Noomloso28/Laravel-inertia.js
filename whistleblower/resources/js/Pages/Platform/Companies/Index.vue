...
const headers = [
    { text: "LOGO", value: "id", sortable: true},
    { text: "Name", value: "name", sortable: true},
    { text: "SLUG", value: "slug", sortable: true},
    { text: "Created", value: "created_at", sortable: true},
    { text: "Created by", value: "user", sortable: true},
                ...
                >
                    <div class="rounded-t bg-white mb-0 px-6 py-6">
                        <div class="text-center flex justify-between">
                            <h6 class="text-blueGray-700 text-xl font-bold mr-2">{{$t('Companies')}}</h6>
                            <div class="relative flex">
                              ...
                              <Link v-if="$page.props.user.permissions.includes('create-companies')"
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        >
                            ...
                            <template #item-id="{id}">
                              <div class="player-wrapper" v-if="companyLogo(id)" >
                                <img :src="route('media.show', companyLogo(id))" alt="company logo" class="avator max-w-100-px">
                              </div>
                            </template>
                            <template #item-actions="{id}">
                                <table-dropdown :id="id" :group="'companies'" :view="false"/>
                            </template>

...
const searchField = ["name", "id", "active", "created_at"];
const sortBy= "name";
const sortType = "desc";
    ...
    <AppLayout title="Platform Companies">
        <div class="flex flex-wrap mt-4">
            <div class="w-full mb-12 px-4">
                ...
                >
<!--                  &lt;!&ndash; flash message start &ndash;&gt;-->
<!--                  <div-->
...
<!--                    </span>-->
<!--                  </div>-->
<!--                  &lt;!&ndash; flash message end &ndash;&gt;-->

                    <div class="rounded-t bg-white mb-0 px-6 py-6">
                        <div class="text-center flex justify-between">
                            <h6 class="text-blueGray-700 text-xl font-bold mr-2">{{$t('Roles')}}</h6>
                    ...
                    <div class="block w-full overflow-x-auto">
                        ...
                        <Vue3EasyDataTable
                            ...
                            header-class-name="roles-header"
                        ...
                        >
                            ...
                            <template #item-actions="{id}">
                                <table-dropdown :id="id" :group="'roles'" :view="false"/>
                            </template>
